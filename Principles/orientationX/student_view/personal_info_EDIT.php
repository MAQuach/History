        ...
        <div class="student_container">
            ...
            <form id="msform" method="post">
                ...
                <fieldset>   
                    ...
                    <h3 id="errormessage" class="fs-subtitle ">*Please review the information and choose which campus you would like to attend orientation at, campus choice will effect which orientation dates you can register for! </h3>
                        ...
                        <div class="col-sm-6">
                            ...
                            if(isset($_POST["fauCampus"])){
                                ...
                                if($student == false || $student == 0){
                                    ...
                                    echo '<input type="button" id="nextButton3" class="next" value="Next" disabled="true">';
                                }
                                if($student == true || $student == 1){
                                    echo '<a href="orientation_Date_EDIT.php" class="next">Select Orientation Date</a>';
